...
TEE_SERVICE_DEPENDENCIES = host-python3 host-py-cryptography host-rustc-nightly optee-client optee-os
...
TEE_SERVICE_PRIV_KEY_PATH=$(BR2_EXTERNAL_ZONDAXTEE_PATH)/keys/optee_keys/optee_priv_key.pem
TEE_SERVICE_PUB_KEY_PATH=$(BR2_EXTERNAL_ZONDAXTEE_PATH)/keys/optee_keys/optee_pub_key.pem
...
ifeq ($(BR2_PACKAGE_TEE_SERVICE_SIGN_TA),y)
# Add some more settings here
TEE_SERVICE_ENV += TA_SIGN_KEY=$(TEE_SERVICE_PRIV_KEY_PATH) SIGN_TA=1 \
				TA_PUB_KEY=$(TEE_SERVICE_PUB_KEY_PATH)
endif
