...
HELLORUSTEE_TA_DEV_KIT_DIR=$(OPTEE_OS_SDK)
HELLORUSTEE_HOST_CROSS_COMPILE=$(STAGING_DIR)
HELLORUSTEE_TA_CROSS_COMPILE=$(TARGET_CROSS)
HELLORUSTEE_TA=TEE
HELLORUSTEE_HOST=REE
HELLORUSTEE_SRC_=$(HELLORUSTEE_DIR)

HELLORUSTEE_CFLAGS 	= -Wall -I$(HELLORUSTEE_SRC_)/$(HELLORUSTEE_TA)/lib/include -I$(HELLORUSTEE_TEEC_EXPORT)/usr/include -I./include -fPIC
